...
STYLE_GUIDE_CATALOG: dict[str, dict[str, Any]] = {
    "GBOOK-TECH": {
        ...
        "description": "IT/기술 전문서. Pretendard 서체, 쿨톤 팔레트, 코드 블록·콜아웃·레이어 구분 최적화.",
        "target": "IT/기술 전문서",
        "params": {
            ...
            "code_font_size": "14px",
            "code_background": "#1b2033",
            "code_color": "#cdd6f4",
            "page_margin": "2.5cm 2cm",
            "callout_border_color": "#3b5bdb",
            "callout_background": "#eef2ff",
    ...
    "GBOOK-TRAVEL": {
        "id": "GBOOK-TRAVEL",
        "name": "Google Books 여행/에세이",
        "description": "여행기·문화 에세이. 웜톤 팔레트, 인용구·장소 카드 강조.",
        "target": "여행기/문화 에세이",
        "params": {
            "body_font": "Noto Serif KR",
            "body_font_size": "16px",
            ...
            "code_font": "Courier New",
            "code_font_size": "13px",
            "code_background": "#fdf6ec",
            "code_color": "#5c3d11",
            "page_margin": "2.5cm 2cm",
            "callout_border_color": "#bf6b36",
            "callout_background": "#fdf3e7",
            "max_line_length": "68ch",
            "toc_depth": 2,
            "figure_numbering": False,
            "table_numbering": False,
        ...
        "css_class": "gbook-travel",
    },
    "GBOOK-KIDS": {
        "id": "GBOOK-KIDS",
        "name": "Google Books 어린이/청소년",
        "description": "어린이·청소년 도서. 큰 글씨, 높은 행간, 생동감 있는 색상.",
        "target": "어린이/청소년",
        "params": {
            "body_font": "Noto Sans KR",
            "body_font_size": "18px",
            ...
            "code_color": "#0c4a6e",
            "page_margin": "2cm 2cm",
            "callout_border_color": "#7C3AED",
            "callout_background": "#f5f3ff",
            "max_line_length": "60ch",
            "toc_depth": 2,
            "figure_numbering": False,
            "table_numbering": False,
            "endnotes": False,
        ...
        "css_class": "gbook-kids",
    },
    "GBOOK-LANG": {
        "id": "GBOOK-LANG",
        "name": "Google Books 언어학습",
        "description": "언어 학습·회화. 예문 박스·발음 주석·대화체 구조 최적화.",
        "target": "언어학습/회화",
        "params": {
            "body_font": "Noto Sans KR",
            "body_font_size": "15px",
            ...
            "code_font": "JetBrains Mono",
            "code_font_size": "14px",
            "code_background": "#f0fdf4",
            "code_color": "#14532d",
            "page_margin": "2cm 1.8cm",
            "callout_border_color": "#059669",
            "callout_background": "#ecfdf5",
            "max_line_length": "70ch",
            "toc_depth": 3,
            "figure_numbering": False,
